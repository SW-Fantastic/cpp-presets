...
public class PdfiumDocument extends org.swdc.pdfium.core.PdfiumDocumentConfigure {
    static { Loader.load(); }

// Parsed from fpdf_doc.h
...
public static final int PDFACTION_UNSUPPORTED = 0;
// Go to a destination within current document.
public static final int PDFACTION_GOTO = 1;
// Go to a destination within another document.
public static final int PDFACTION_REMOTEGOTO = 2;
// URI, including web pages and other Internet resources.
public static final int PDFACTION_URI = 3;
// Launch an application or open a file.
public static final int PDFACTION_LAUNCH = 4;
// Go to a destination in an embedded file.
public static final int PDFACTION_EMBEDDEDGOTO = 5;

// View destination fit types. See pdfmark reference v9, page 48.
public static final int PDFDEST_VIEW_UNKNOWN_MODE = 0;
public static final int PDFDEST_VIEW_XYZ = 1;
public static final int PDFDEST_VIEW_FIT = 2;
public static final int PDFDEST_VIEW_FITH = 3;
public static final int PDFDEST_VIEW_FITV = 4;
public static final int PDFDEST_VIEW_FITR = 5;
public static final int PDFDEST_VIEW_FITB = 6;
public static final int PDFDEST_VIEW_FITBH = 7;
public static final int PDFDEST_VIEW_FITBV = 8;
...
// described in ISO 32000-1:2008, section 12.3.3.
 public static native fpdf_bookmark_t__ FPDFBookmark_GetFirstChild(fpdf_document_t__ document, fpdf_bookmark_t__ bookmark);
...
// references, as may arise from malformed documents.
 public static native fpdf_bookmark_t__ FPDFBookmark_GetNextSibling(fpdf_document_t__ document, fpdf_bookmark_t__ bookmark);
...
// required length, or |buffer| is NULL, |buffer| will not be modified.
 public static native @Cast("unsigned long") long FPDFBookmark_GetTitle(fpdf_bookmark_t__ bookmark,
                      Pointer buffer,
...
// Returns 0 if the bookmark has no children or is invalid.
 public static native int FPDFBookmark_GetCount(fpdf_bookmark_t__ bookmark);
...
// multiple bookmarks have the same |title|.
 public static native fpdf_bookmark_t__ FPDFBookmark_Find(fpdf_document_t__ document, @Cast("unsigned short*") ShortPointer title);
public static native fpdf_bookmark_t__ FPDFBookmark_Find(fpdf_document_t__ document, @Cast("unsigned short*") ShortBuffer title);
public static native fpdf_bookmark_t__ FPDFBookmark_Find(fpdf_document_t__ document, @Cast("unsigned short*") short[] title);
...
// associated with |bookmark|.
 public static native fpdf_dest_t__ FPDFBookmark_GetDest(fpdf_document_t__ document, fpdf_bookmark_t__ bookmark);
...
// the |bookmark| destination data.
 public static native fpdf_action_t__ FPDFBookmark_GetAction(fpdf_bookmark_t__ bookmark);
...
//   PDFACTION_URI
//   PDFACTION_LAUNCH
 public static native @Cast("unsigned long") long FPDFAction_GetType(fpdf_action_t__ action);
...
// the document handle from that document as |document| to FPDFAction_GetDest().
 public static native fpdf_dest_t__ FPDFAction_GetDest(fpdf_document_t__ document,
                                                       fpdf_action_t__ action);
...
// will not be modified.
 public static native @Cast("unsigned long") long FPDFAction_GetFilePath(fpdf_action_t__ action, Pointer buffer, @Cast("unsigned long") long buflen);
...
// behavior prior to commit d609e84cee.
 public static native @Cast("unsigned long") long FPDFAction_GetURIPath(fpdf_document_t__ document,
                      fpdf_action_t__ action,
                      Pointer buffer,
                      @Cast("unsigned long") long buflen);
...
// Returns the 0-based page index containing |dest|. Returns -1 on error.
 public static native int FPDFDest_GetDestPageIndex(fpdf_document_t__ document,
                                                        fpdf_dest_t__ dest);
...
// |dest| does not specify a view.
 public static native @Cast("unsigned long") long FPDFDest_GetView(fpdf_dest_t__ dest, @Cast("unsigned long*") CLongPointer pNumParams, @Cast("FS_FLOAT*") FloatPointer pParams);
public static native @Cast("unsigned long") long FPDFDest_GetView(fpdf_dest_t__ dest, @Cast("unsigned long*") CLongPointer pNumParams, @Cast("FS_FLOAT*") FloatBuffer pParams);
public static native @Cast("unsigned long") long FPDFDest_GetView(fpdf_dest_t__ dest, @Cast("unsigned long*") CLongPointer pNumParams, @Cast("FS_FLOAT*") float[] pParams);
...
// hasYVal or hasZoomVal flags are true.
 public static native @Cast("FPDF_BOOL") int FPDFDest_GetLocationInPage(fpdf_dest_t__ dest,
                           @Cast("FPDF_BOOL*") IntPointer hasXVal,
                           @Cast("FPDF_BOOL*") IntPointer hasYVal,
                           @Cast("FPDF_BOOL*") IntPointer hasZoomVal,
                           @Cast("FS_FLOAT*") FloatPointer x,
                           @Cast("FS_FLOAT*") FloatPointer y,
                           @Cast("FS_FLOAT*") FloatPointer zoom);
public static native @Cast("FPDF_BOOL") int FPDFDest_GetLocationInPage(fpdf_dest_t__ dest,
                           @Cast("FPDF_BOOL*") IntBuffer hasXVal,
                           @Cast("FPDF_BOOL*") IntBuffer hasYVal,
                           @Cast("FPDF_BOOL*") IntBuffer hasZoomVal,
                           @Cast("FS_FLOAT*") FloatBuffer x,
                           @Cast("FS_FLOAT*") FloatBuffer y,
                           @Cast("FS_FLOAT*") FloatBuffer zoom);
public static native @Cast("FPDF_BOOL") int FPDFDest_GetLocationInPage(fpdf_dest_t__ dest,
                           @Cast("FPDF_BOOL*") int[] hasXVal,
                           @Cast("FPDF_BOOL*") int[] hasYVal,
                           @Cast("FPDF_BOOL*") int[] hasZoomVal,
                           @Cast("FS_FLOAT*") float[] x,
                           @Cast("FS_FLOAT*") float[] y,
                           @Cast("FS_FLOAT*") float[] zoom);
...
// FPDF_DeviceToPage().
 public static native fpdf_link_t__ FPDFLink_GetLinkAtPoint(fpdf_page_t__ page,
                                                            double x,
                                                            double y);
...
// You can convert coordinates from screen coordinates to page coordinates using
// FPDF_DeviceToPage().
 public static native int FPDFLink_GetLinkZOrderAtPoint(fpdf_page_t__ page,
                                                            double x,
                                                            double y);
...
// to retrieve the action associated with |link|.
 public static native fpdf_dest_t__ FPDFLink_GetDest(fpdf_document_t__ document,
                                                     fpdf_link_t__ link);
...
// valid.
 public static native fpdf_action_t__ FPDFLink_GetAction(fpdf_link_t__ link);
...
// Returns TRUE on success.
 public static native @Cast("FPDF_BOOL") int FPDFLink_Enumerate(fpdf_page_t__ page,
                                                       IntPointer start_pos,
                                                       @Cast("fpdf_link_t__**") PointerPointer link_annot);
public static native @Cast("FPDF_BOOL") int FPDFLink_Enumerate(fpdf_page_t__ page,
                                                       IntPointer start_pos,
                                                       @ByPtrPtr fpdf_link_t__ link_annot);
public static native @Cast("FPDF_BOOL") int FPDFLink_Enumerate(fpdf_page_t__ page,
                                                       IntBuffer start_pos,
                                                       @ByPtrPtr fpdf_link_t__ link_annot);
public static native @Cast("FPDF_BOOL") int FPDFLink_Enumerate(fpdf_page_t__ page,
...
// if the input link annot or page is NULL.
 public static native fpdf_annotation_t__ FPDFLink_GetAnnot(fpdf_page_t__ page, fpdf_link_t__ link_annot);
...
//
// Returns true on success.
 public static native @Cast("FPDF_BOOL") int FPDFLink_GetAnnotRect(fpdf_link_t__ link_annot,
                                                          FS_RECTF rect);
...
// Returns the count of quadrilateral points.
 public static native int FPDFLink_CountQuadPoints(fpdf_link_t__ link_annot);
...
//
// Returns true on success.
 public static native @Cast("FPDF_BOOL") int FPDFLink_GetQuadPoints(fpdf_link_t__ link_annot,
                       int quad_index,
...
//   valid.
 public static native fpdf_action_t__ FPDF_GetPageAAction(fpdf_page_t__ page,
                                                          int aa_type);
...
// NULL, |buffer| will not be modified.
 public static native @Cast("unsigned long") long FPDF_GetFileIdentifier(fpdf_document_t__ document,
                       @Cast("FPDF_FILEIDTYPE") int id_type,
                       Pointer buffer,
                       @Cast("unsigned long") long buflen);
...
// is no guarantee the metadata has been loaded.
 public static native @Cast("unsigned long") long FPDF_GetMetaText(fpdf_document_t__ document,
                                                         @Cast("const char*") BytePointer tag,
                                                         Pointer buffer,
                                                         @Cast("unsigned long") long buflen);
public static native @Cast("unsigned long") long FPDF_GetMetaText(fpdf_document_t__ document,
                                                         String tag,
...
// bytes of zeros indicating the end of the string.  If |buflen| is less than
// the returned length, or |buffer| is NULL, |buffer| will not be modified.
 public static native @Cast("unsigned long") long FPDF_GetPageLabel(fpdf_document_t__ document,
                  int page_index,
                  Pointer buffer,
                  @Cast("unsigned long") long buflen);
