...
public class PdfiumText extends org.swdc.pdfium.conf.PdfiumTextConfigure {
    static { Loader.load(); }

// Parsed from fpdf_text.h
...
//          information.
//
 public static native fpdf_textpage_t__ FPDFText_LoadPage(fpdf_page_t__ page);
...
//          None.
//
 public static native void FPDFText_ClosePage(fpdf_textpage_t__ text_page);
...
//
 public static native int FPDFText_CountChars(fpdf_textpage_t__ text_page);
...
//
 public static native @Cast("unsigned int") int FPDFText_GetUnicode(fpdf_textpage_t__ text_page, int index);
...
//
 public static native int FPDFText_IsGenerated(fpdf_textpage_t__ text_page, int index);
...
//          -1 if there was an error.
//
 public static native int FPDFText_IsHyphen(fpdf_textpage_t__ text_page, int index);
...
//          -1 if there was an error.
//
 public static native int FPDFText_HasUnicodeMapError(fpdf_textpage_t__ text_page, int index);
...
//          "em size").
//
 public static native double FPDFText_GetFontSize(fpdf_textpage_t__ text_page,
                                                      int index);
...
//          failure.
//
 public static native @Cast("unsigned long") long FPDFText_GetFontInfo(fpdf_textpage_t__ text_page,
                     int index,
                     Pointer buffer,
...
//
 public static native int FPDFText_GetFontWeight(fpdf_textpage_t__ text_page,
                                                     int index);
...
//
 public static native @Cast("FPDF_TEXT_RENDERMODE") int FPDFText_GetTextRenderMode(fpdf_textpage_t__ text_page, int index);
...
//          unchanged.
//
 public static native @Cast("FPDF_BOOL") int FPDFText_GetFillColor(fpdf_textpage_t__ text_page,
                      int index,
...
//          unchanged.
//
 public static native @Cast("FPDF_BOOL") int FPDFText_GetStrokeColor(fpdf_textpage_t__ text_page,
                        int index,
                        @Cast("unsigned int*") IntPointer R,
                        @Cast("unsigned int*") IntPointer G,
                        @Cast("unsigned int*") IntPointer B,
...
//
 public static native float FPDFText_GetCharAngle(fpdf_textpage_t__ text_page,
                                                      int index);
...
//
 public static native @Cast("FPDF_BOOL") int FPDFText_GetCharBox(fpdf_textpage_t__ text_page,
                                                        int index,
                                                        DoublePointer left,
                                                        DoublePointer right,
                                                        DoublePointer bottom,
                                                        DoublePointer top);
public static native @Cast("FPDF_BOOL") int FPDFText_GetCharBox(fpdf_textpage_t__ text_page,
                                                        int index,
                                                        DoubleBuffer left,
...
//          All positions are measured in PDF "user space".
//
 public static native @Cast("FPDF_BOOL") int FPDFText_GetLooseCharBox(fpdf_textpage_t__ text_page, int index, FS_RECTF rect);
...
//
 public static native @Cast("FPDF_BOOL") int FPDFText_GetMatrix(fpdf_textpage_t__ text_page,
                                                       int index,
                                                       FS_MATRIX matrix);
...
//          All positions are measured in PDF "user space".
//
 public static native @Cast("FPDF_BOOL") int FPDFText_GetCharOrigin(fpdf_textpage_t__ text_page,
                       int index,
                       DoublePointer x,
                       DoublePointer y);
public static native @Cast("FPDF_BOOL") int FPDFText_GetCharOrigin(fpdf_textpage_t__ text_page,
...
//
 public static native int FPDFText_GetCharIndexAtPos(fpdf_textpage_t__ text_page,
                           double x,
                           double y,
                           double xTolerance,
                           double yTolerance);
...
//          FPDFText_GetCharBox().
//
 public static native int FPDFText_GetText(fpdf_textpage_t__ text_page,
                                               int start_index,
                                               int count,
                                               @Cast("unsigned short*") ShortPointer result);
public static native int FPDFText_GetText(fpdf_textpage_t__ text_page,
                                               int start_index,
                                               int count,
                                               @Cast("unsigned short*") ShortBuffer result);
public static native int FPDFText_GetText(fpdf_textpage_t__ text_page,
                                               int start_index,
                                               int count,
                                               @Cast("unsigned short*") short[] result);
...
//
 public static native int FPDFText_CountRects(fpdf_textpage_t__ text_page,
                                                  int start_index,
                                                  int count);
...
//          parameters to 0.
//
 public static native @Cast("FPDF_BOOL") int FPDFText_GetRect(fpdf_textpage_t__ text_page,
                                                     int rect_index,
                                                     DoublePointer left,
                                                     DoublePointer top,
                                                     DoublePointer right,
...
//          it.
//
 public static native int FPDFText_GetBoundedText(fpdf_textpage_t__ text_page,
                                                      double left,
                                                      double top,
                                                      double right,
                                                      double bottom,
...
public static final int FPDF_CONSECUTIVE = 0x00000004;
...
//
 public static native fpdf_schhandle_t__ FPDFText_FindStart(fpdf_textpage_t__ text_page,
                   @Cast("unsigned short*") ShortPointer findwhat,
                   @Cast("unsigned long") long flags,
                   int start_index);
public static native fpdf_schhandle_t__ FPDFText_FindStart(fpdf_textpage_t__ text_page,
                   @Cast("unsigned short*") ShortBuffer findwhat,
                   @Cast("unsigned long") long flags,
                   int start_index);
public static native fpdf_schhandle_t__ FPDFText_FindStart(fpdf_textpage_t__ text_page,
                   @Cast("unsigned short*") short[] findwhat,
                   @Cast("unsigned long") long flags,
                   int start_index);
...
//
 public static native @Cast("FPDF_BOOL") int FPDFText_FindNext(fpdf_schhandle_t__ handle);
...
//          Whether a match is found.
//
 public static native @Cast("FPDF_BOOL") int FPDFText_FindPrev(fpdf_schhandle_t__ handle);
...
//
 public static native int FPDFText_GetSchResultIndex(fpdf_schhandle_t__ handle);
...
//
 public static native int FPDFText_GetSchCount(fpdf_schhandle_t__ handle);
...
//          None.
//
 public static native void FPDFText_FindClose(fpdf_schhandle_t__ handle);
...
//
 public static native fpdf_pagelink_t__ FPDFLink_LoadWebLinks(fpdf_textpage_t__ text_page);
...
//
 public static native int FPDFLink_CountWebLinks(fpdf_pagelink_t__ link_page);
...
//          is an empty string.
//
 public static native int FPDFLink_GetURL(fpdf_pagelink_t__ link_page,
                                              int link_index,
                                              @Cast("unsigned short*") ShortPointer buffer,
                                              int buflen);
public static native int FPDFLink_GetURL(fpdf_pagelink_t__ link_page,
...
//
 public static native int FPDFLink_CountRects(fpdf_pagelink_t__ link_page,
                                                  int link_index);
...
//
 public static native @Cast("FPDF_BOOL") int FPDFLink_GetRect(fpdf_pagelink_t__ link_page,
                                                     int link_index,
                                                     int rect_index,
                                                     DoublePointer left,
                                                     DoublePointer top,
...
//          parameters remain unmodified.
//
 public static native @Cast("FPDF_BOOL") int FPDFLink_GetTextRange(fpdf_pagelink_t__ link_page,
                      int link_index,
                      IntPointer start_char_index,
                      IntPointer char_count);
public static native @Cast("FPDF_BOOL") int FPDFLink_GetTextRange(fpdf_pagelink_t__ link_page,
                      int link_index,
                      IntBuffer start_char_index,
                      IntBuffer char_count);
public static native @Cast("FPDF_BOOL") int FPDFLink_GetTextRange(fpdf_pagelink_t__ link_page,
                      int link_index,
...
//          None.
//
 public static native void FPDFLink_CloseWebLinks(fpdf_pagelink_t__ link_page);
