...
public class Local_infile_error_Pointer_ByteBuffer_int extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public    Local_infile_error_Pointer_ByteBuffer_int(Pointer p) { super(p); }
    protected Local_infile_error_Pointer_ByteBuffer_int() { allocate(); }
