...
public class Local_infile_init_Pointer_String_Pointer extends FunctionPointer {
    static { Loader.load(); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public    Local_infile_init_Pointer_String_Pointer(Pointer p) { super(p); }
    protected Local_infile_init_Pointer_String_Pointer() { allocate(); }
    private native void allocate();
    public native int call(@Cast("void**") @ByPtrPtr Pointer arg0, String arg1,
                            Pointer arg2);
}
