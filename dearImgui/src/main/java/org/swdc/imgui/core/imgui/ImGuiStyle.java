...
public class ImGuiStyle extends Pointer {
    ...
    public native float DockingSeparatorSize(); public native ImGuiStyle DockingSeparatorSize(float setter);         // Thickness of resizing border between docked windows
