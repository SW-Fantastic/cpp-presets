...
CIMGUI_API ImGuiContext* ImGui_CreateContext(ImFontAtlas* shared_font_atlas);
CIMGUI_API void          ImGui_DestroyContext(ImGuiContext* ctx );  // NULL = destroy current context
