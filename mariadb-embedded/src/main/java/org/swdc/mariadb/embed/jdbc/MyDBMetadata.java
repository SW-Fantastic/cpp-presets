...
public class MyDBMetadata implements DatabaseMetaData {
     ...
     */
    public MyDBMetadata(MyConnection connection) {
        this.connection = connection;
    }

    private static String DataTypeClause() {
    ...
    private ResultSet getImportedKeys(
            String tableDef, String tableName, String catalog,MyConnection connection)
        ...
        MyCompleteResult rs = new MyCompleteResult(null);
        for (int idx = 0; idx < dataTypes.length; idx ++) {
            rs.field(idx,columnNames[idx],dataTypes[idx]);
        }
        ...
        for (String part : parts) {
            ...
            for (int i = 0; i < primaryKeyCols.size(); i++) {
                ...
                row[8] = i + 1; // KEY_SEQ
                row[9] = onUpdateReferenceAction; // UPDATE_RULE
                row[10] = onDeleteReferenceAction; // DELETE_RULE
    ...
    private Map<String[], String> getExtImportedKeys(
            String tableName, MyConnection connection) throws SQLException {
    ...
    private ResultSet executeQuery(String sql) throws SQLException {
        ...
        MyQueryResult rs = (MyQueryResult) stmt.executeQuery(sql);
    ...
    private String escapeQuote(String value) {
        return value == null
                ...
                + escapeString(
                value,
                (connection.connection.getServerStatus() & MyCom.SERVER_STATUS_NO_BACKSLASH_ESCAPES) > 0)
                + "'";
    }
    ...
    private boolean patternCond(
        ...
        sb.append(firstCondition ? " WHERE " : " AND ")
                ...
                .append(
                        escapeString(
                                tableName,
                                (connection.connection.getServerStatus() & MyCom.SERVER_STATUS_NO_BACKSLASH_ESCAPES)
                                        != 0))
                .append("'");
        return false;
    }
    ...
    public ResultSet getColumns(
        ...
        boolean supportsFractionalSeconds = true;
        StringBuilder sb = new StringBuilder();
        sb.append(
    ...
    public ResultSet getBestRowIdentifier(
        ...
        boolean hasIsGeneratedCol = true;
    ...
    public String getDatabaseProductVersion() {
        ...
        long major = connection.connection.getMajorVersion();
        long miner = connection.connection.getMinerVersion();
        long sub = connection.connection.getSubVersion();
        return major + "." + miner + "." + sub;
    ...
    public int getDriverMajorVersion() {
        return (int) connection.connection.getMajorVersion();
    }

    public int getDriverMinorVersion() {
        return (int) connection.connection.getMinerVersion();
    }
    ...
    public ResultSet getTypeInfo() {
        ...
        MyCompleteResult completeResult = new MyCompleteResult(null);
        for (int idx = 0; idx < columnNames.length; idx ++) {
            completeResult.field(
                    idx,
                    columnNames[idx],
                    dataTypes[idx]
            );
    ...
    public ResultSet getClientInfoProperties() {
        ...
        MyCompleteResult result = new MyCompleteResult(null);
        for (int idx = 0; idx < columnNames.length; idx++) {
            result.field(idx,columnNames[idx],types[idx]);
        }
