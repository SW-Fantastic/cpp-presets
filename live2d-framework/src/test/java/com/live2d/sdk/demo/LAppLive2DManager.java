...
import static com.live2d.sdk.demo.LAppDefine.DEBUG_LOG_ENABLE;
...
public class LAppLive2DManager {
    ...
    public static LAppLive2DManager createInstance(GL2 gles2) {
        if (s_instance == null) {
            s_instance = new LAppLive2DManager(gles2);
        }
        return s_instance;
    }
    ...
    public static LAppLive2DManager getInstance() {
        if (s_instance == null) {
            throw new RuntimeException("please init fist.");
        }
        return s_instance;
    }
    ...
    public void setUpModel() {
        ...
        final AssetManager assets = LAppDelegate.getInstance().getAssets();
        try {
    ...
    public void changeScene(int index) {
        ...
        models.add(new LAppModel(gles2));
    ...
    private LAppLive2DManager(GL2 gles2) {
        this.gles2 = gles2;
        setUpModel();
        changeScene(0);
    }
