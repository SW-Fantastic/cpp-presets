...
public class LAppView implements AutoCloseable {
    ...
    public void initialize() {
        ...
        spriteShader = new LAppSpriteShader(gles2);
    }
    ...
    public void initializeSprite() {
        ...
        LAppTextureManager.TextureInfo backgroundTexture = textureManager.createTextureFromPngFile(
                LAppDefine.ResourcePath.ROOT.getPath() + LAppDefine.ResourcePath.BACK_IMAGE.getPath()
        );
        ...
        if (backSprite == null) {
            backSprite = new LAppSprite(x, y, fWidth, fHeight, backgroundTexture.id, programId,gles2);
        } else {
        ...
        LAppTextureManager.TextureInfo gearTexture = textureManager.createTextureFromPngFile(
                LAppDefine.ResourcePath.ROOT.getPath() + LAppDefine.ResourcePath.GEAR_IMAGE.getPath()
        );
        ...
        if (gearSprite == null) {
            gearSprite = new LAppSprite(x, y, fWidth, fHeight, gearTexture.id, programId,gles2);
        } else {
        ...
        LAppTextureManager.TextureInfo powerTexture = textureManager.createTextureFromPngFile(
                LAppDefine.ResourcePath.ROOT.getPath() + LAppDefine.ResourcePath.POWER_IMAGE.getPath()
        );
        ...
        if (powerSprite == null) {
            powerSprite = new LAppSprite(x, y, fWidth, fHeight, powerTexture.id, programId,gles2);
        } else {
        ...
        if (renderingSprite == null) {
            renderingSprite = new LAppSprite(x, y, windowWidth, windowHeight, 0, programId,gles2);
        } else {
