 ...
 */
public class CubismClippingContextLWGL extends ACubismClippingContext {
    /**
     * コンストラクタ
     *
     ...
     */
    public CubismClippingContextLWGL(
     ...
     */
    @Override
    public CubismClippingManagerLWGL getClippingManager() {
        // キャストに失敗する可能性があります。その場合は内部でClassCastExceptionが送出されます。
        return (CubismClippingManagerLWGL) owner;
    }
}
