 ...
 */
public class CubismClippingContextOGL extends ACubismClippingContext {
    /**
     * コンストラクタ
     *
     ...
     */
    public CubismClippingContextOGL(
     ...
     */
    @Override
    public CubismClippingManagerOGL getClippingManager() {
        // キャストに失敗する可能性があります。その場合は内部でClassCastExceptionが送出されます。
        return (CubismClippingManagerOGL) owner;
    }
}
