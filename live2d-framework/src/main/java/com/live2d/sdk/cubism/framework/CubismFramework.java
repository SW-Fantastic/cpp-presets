...
public class CubismFramework {
    ...
    public static boolean startUp(final Option option) {
        if (s_isStarted) {
            CubismDebug.cubismLogInfo("CubismFramework.startUp() is already done.");
    ...
    public static void initialize() {
        ...
        if (!s_isStarted) {
            CubismDebug.cubismLogWarning("CubismFramework is not started.");
            return;
        }

        // Disturb consecutive securing resources.
        if (s_isInitialized) {
            CubismDebug.cubismLogWarning("CubismFramework.initialize() skipped, already initialized.");
            return;
        }
        ...
        CubismDebug.cubismLogInfo("CubismFramework::Initialize() is complete.");
    }
    ...
    public static void dispose() {
        ...
        if (!s_isInitialized) {
            CubismDebug.cubismLogWarning("CubismFramework.dispose() skipped, not initialized.");
            return;
        }
        ...
        CubismDebug.cubismLogInfo("CubismFramework.dispose() is complete.");
    }
