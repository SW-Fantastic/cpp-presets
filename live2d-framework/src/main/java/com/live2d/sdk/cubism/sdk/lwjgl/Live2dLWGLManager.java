...
public class Live2dLWGLManager {

    private final List<Live2dLWGLModel> models = new ArrayList<>();
    ...
    public void releaseAllModel() {
        for (Live2dLWGLModel model : models) {
            model.deleteModel();
        }
        models.clear();
    ...
    public void onUpdate() {
        ...
        for (int i = 0; i < models.size(); i++) {
            Live2dLWGLModel model = models.get(i);
    ...
    public void onDrag(float x, float y) {
        for (int i = 0; i < models.size(); i++) {
            Live2dLWGLModel model = getModel(i);
