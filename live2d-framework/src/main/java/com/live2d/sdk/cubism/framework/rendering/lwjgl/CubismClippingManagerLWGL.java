 ...
 */
class CubismClippingManagerLWGL extends ACubismClippingManager<
        CubismClippingContextLWGL,
        CubismOffscreenSurfaceLWGL
     ...
     * コンストラクタ
     */
    public CubismClippingManagerLWGL() {
        super();
    }
     ...
     */
    public void setupClippingContext(CubismModel model, CubismRendererLWGL renderer, int[] lastFBO, int[] lastViewport) {
        ...
        for (int i = 0; i < clippingContextListForMask.size(); i++) {
            CubismClippingContextLWGL clipContext = clippingContextListForMask.get(i);
        ...
        GL30.glViewport(0, 0, (int) clippingMaskBufferSize.x, (int) clippingMaskBufferSize.y);
        ...
        for (int j = 0; j < clippingContextListForMask.size(); j++) {
            CubismClippingContextLWGL clipContext = clippingContextListForMask.get(j);
            ...
            final CubismOffscreenSurfaceLWGL clipContextOffscreenSurface = renderer.getMaskBuffer(clipContext.bufferIndex);
